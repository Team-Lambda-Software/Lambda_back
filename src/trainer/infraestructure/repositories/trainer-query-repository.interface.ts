...
export interface TrainerQueryRepository {
  ...
  findTrainersByLocation(
    latitude: string,
    longitude: string,
    pagination: PaginationDto,
  ): Promise<Result<OdmTrainerEntity[]>>; //to-do Revamp Location from string into something more useful
  findTrainersByFollower(
    followerID: string,
    pagination: PaginationDto,
  ...
  saveTrainer(trainer: OdmTrainerEntity): Promise<Result<void>>;
}
